...
bh_entrance : OutdoorRoom
'Baker Hall (Outside)' 'Baker'
...
bh_entry : Room
'Baker Hall (Entry)' 'Baker'
"This is a place, for sure. " {
    down = bh_entrance;
}

bh_1_east : Room
'Baker Hall (First Floor)' 'Baker'
...
bh_bookstore_entrance : Room
'Baker Hall (near the Bookstore)' 'Baker'
