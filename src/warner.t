...
warner_entrance : OutdoorRoom 'building' 'Warner Hall (Outside)'
"You are standing on a north-south walkway outside Warner Hall.
	The recently bought marble exterior ($180,000) impresses you beyond words.
...
#ifdef IMPL
warner_forbes : OutdoorRoom 'warner' 'Warner Hall (near Forbes Ave.)'
...
//"A high wall stops you from getting to Warner Hall.
#endif

warner_hall : Room 'warner' 'Warner Hall'
